          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <h2 className="text-4xl font-bold text-gray-900 mb-8 text-balance">
                  Who We Are
                </h2>
                <div className="space-y-6 text-gray-700 leading-relaxed">
                  <p>
                    Immigrant at Large Canada was founded with a mission to
                    amplify the voices of immigrants and advocate for their
                    rightful recognition and inclusion in Canadian society. What
                    began as a passionate movement has evolved into a
                    comprehensive organization dedicated to supporting and
                    empowering immigrants from all walks of life.
                  </p>
                  <p>
                    We believe that immigrants are not just participants in
                    Canadian society—they are essential contributors who bring
                    unique perspectives, skills, and experiences. Through a
                    variety of impactful programs, community-led initiatives,
                    and advocacy efforts, we work to ensure that immigrants have
                    access to the resources, support, and opportunities they
                    need to thrive. At the heart of our work is the belief that
                ...
                <div className="mt-12 space-y-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        ...
                        empowering immigrants through a variety of impactful
                        programs and initiatives. We are committed to building a
                        thriving community where everyone has the opportunity to
                        succeed.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        To create a Canada where every immigrant thrives with
                        dignity, opportunities and belonging, from empowerment
                        to lead, contribute, and transform their communities.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  We help immigrants and newcomers around the world access
                  essential resources to build stable, empowered lives. Our
                  services are personalized and comprehensive, supporting every
                  stage of the settlement journey.
                </p>
              </div>
                ...
                return (
                  ...
                  >
                    <CardContent className="p-8 text-center">
                      ...
                      <Link
                        href={service.link}
                        className="bg-blue-600 hover:bg-blue-700 text-white cursor-pointer px-6 py-2 rounded-lg shadow-md transition-colors"
                      >
                        LEARN MORE
                      </Link>
                    </CardContent>
