      ...
      <header className="fixed top-0 w-full bg-white backdrop-blur-md shadow-md z-50 border-b border-yellow-500/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-24">
          ...
          <nav className="hidden md:flex space-x-6 items-center">
            <Link href="/about-us" className="text-black hover:text-blue-600 font-medium transition-colors">
              ABOUT
            </Link>
            <Link href="#category" className="text-black hover:text-blue-600 font-medium transition-colors">
              CATEGORIES
            </Link>
            <Link href="/become-an-exhibitor" className="text-black hover:text-blue-600 font-medium transition-colors">
              BECOME A VENDOR
            </Link>
            <Link href="/contact-us" className="text-black hover:text-blue-600 font-medium transition-colors">
              CONTACT
            </Link>
