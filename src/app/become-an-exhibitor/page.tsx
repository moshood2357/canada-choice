...
export default function BecomeAnExhibitor() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Build valuable partnerships and collaborations within the thriving Afro-Caribbean business ecosystem",
    },
    {
      icon: Megaphone,
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-canada-gold">
              ...
              <p className="text-canada-gold text-sm">+1(613)501-8351</p>
            </div>
          </div>
...
>
        <DialogContent className="max-w-2xl mx-auto bg-black/95 backdrop-blur-sm border-canada-gold max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <p className="text-canada-gold font-semibold text-center">
          ...
          {submitSuccess ? (
            ...
            <form onSubmit={handleApplicationSubmit} className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4">
                ...
                <Button
                  type="submit"
                  className="flex-1 btn-primary-dark font-semibold cursor-pointer"
                  disabled={isSubmitting}
                >
